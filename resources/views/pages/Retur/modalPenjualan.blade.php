<div class="modal" tabindex="-1" role="dialog" id="penjualanModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">     
                <div class="container">
                    ...
                    <div class="col-lg-4 col-6 float-left pb-4">
                        <table>
                            <tr>
                                <th> No Transaksi </th>
                                <th class="no_transaksi"> : <span id="id-transaksi"></span>  </th>
                            </tr>
                            <!-- no transaksi, tannga order, nama toko, alamat toko,kode_toko, username -->
