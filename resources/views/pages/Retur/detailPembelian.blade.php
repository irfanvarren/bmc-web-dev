            ...
            <div class="row">
                <div class="container pt-3">
                    ...
                    <div class="col-lg-4 float-left text-right">
                        <font class="h3"> <strong> RETUR PEMBELIAN </strong> </font> <br>
                        ...
                        <table>
                            <table>
                                <tr>
                                    <td> Nama Toko  </td>
                                    <td class="pl-2 pr-2"> : </td>
                                    <td> <input type="text" value="{{$all_pembelian[0]['nama_toko']}}" id="nama_toko" class="nota-edited" readonly></td>
                                </tr>
                                <tr>
                                    <td> Alamat Toko  </td>
                                    <td class="pl-2 pr-2"> : </td>
                                    <td> <input type="text" value="{{$all_pembelian[0]['alamat_toko']}}" id="alamat_toko" class="nota-edited" readonly></td>
                                </tr>
                            </table>
                        </table>
                    </div>
                        ...
                        <table>
                            <table>
                                <tr>
                                    <td> Metode Bayar </td>
                                    <td class="pl-2 pr-2"> : </td>
                                    <td> <input type="text" value="{{$all_pembelian[0]['metode_pembayaran']}}" id="metode_pembayaran" class="nota-edited" readonly></td>
                                </tr>
                                <tr>
                                    <td> Status  </td>
                                    <td class="pl-2 pr-2"> : </td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered w-100">
                                ...
                                @else
                                    ...
                                    @foreach ($all_retur_pembelian as $a_r_p)
...
<script>
    ...
    $(document).ready(function(){
        $('#btn_retur').click(function(){
            const id_pembelian = $('#id_transaksi').val();
            ...
            Swal.fire({
                icon: 'warning',
                title: 'Peringatan',
                html : '<font> Jumlah Stock akan berkurang !!</font> <br> Jika Menyetujui retur',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url : '<?= asset('/adm/nota-pembelian/simpan_retur') ?>',
                        method : 'POST',
                        data : {
                        ...
                        success:function(data){
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Berhasil',
                                text: 'Nota Retur Pembelian telah dibuat',
                                timer : 1500
                            });
